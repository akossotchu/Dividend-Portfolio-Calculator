...
![Investment Tool](https://img.shields.io/badge/investment-Dividend%20Planning-orange)
...
## 💰 Dividend Portfolio Planning Made Easy
...
```
See the [requirements.txt](requirements.txt) file for all dependencies.
...
1. **Compound Growth**: Principal × (1 + Rate)^Time
2. **Dividend Income**: Principal × Yield Rate
3. **Yield on Cost**: Annual Dividend Income ÷ Total Contributed Capital
4. **Tax-Adjusted Returns**: Dividend × (1 - Tax Rate)
...
- [**app.py**](app.py): Main application with UI and calculation logic
...
<p align="center">
  <em>Your support helps maintain and enhance this tool for all dividend investors</em>
</p>
